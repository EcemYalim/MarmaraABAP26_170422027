CLASS zcl_170422027_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422027_rest_client_02 IMPLEMENTATION.
...
* io_out->write( user_delete(  ) ).
  ...
  METHOD user_get.
    rv_text = execute_request(
     iv_method = 'GET'
     iv_url = gc_base_url && '/user/demo/170422027').
  ENDMETHOD.
  ...
  METHOD user_delete.
    rv_text = execute_request(
     iv_method = 'DELETE'
     iv_url = gc_base_url && '/user/demo_170422027').
  ENDMETHOD.
  ...
  METHOD build_user_json.
    ...
    '{' &&
    '"id": 14,' &&
    '"username": "demo_170422027",' &&
    '"firstName": "Duygu",' &&
    '"lastName": "Kilic",' &&
    '"email": "dygkilic@hotmail.com",' &&
    '"password": "123456",' &&
    '"phone": "123456788",' &&
    '"userStatus": 1' &&
    '}'.
